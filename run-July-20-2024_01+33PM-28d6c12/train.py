...
def main():
    ...
    dataset_config = BaseDatasetConfig(
        formatter="ljspeech",  # Pode usar ljspeech se seu csv for no formato path|text
    ...
    config = GlowTTSConfig(
        ...
        use_phonemes=True,
        phoneme_language="pt-br",  # Ajustar para português brasileiro
        ...
        min_text_len=1,  # Ajustar para evitar que amostras sejam descartadas
        max_text_len=500,
        min_audio_len=1,  # Ajustar para evitar que amostras sejam descartadas
        max_audio_len=500000,
        eval_split_size=0.1,  # Ajuste este valor conforme necessário
    )
